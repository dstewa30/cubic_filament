...
rA = np.array([0.0, 350.0, 350.0])
rB = np.array([1000.0, 350.0, 350.0])
c = cm.cylinder(350.0, rA, rB)

runmax = 1050

for run_i_m1 in range(1, runmax):
    ...
    toggle_plot_hit_detection = 0
    toggle_plot_degree = 0
